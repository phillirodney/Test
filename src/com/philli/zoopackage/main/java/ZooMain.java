...
public class ZooMain {
	...
	public static void main(String[] args) {
		...
		Crocodile croc = new Crocodile(150, "noot noot", "broad snouted caiman", 80, 90, EnclosureType.REPTILE_CREEK, false, false, "M");
		croc.nutrition();
		croc.floats();
		croc.growth();
		System.out.println("\n");
		...
		Pigeon pigeon = new Pigeon(30, "Greg", "nicobar pigeon", 10, 10, EnclosureType.WORLD_OF_WINGS, false, false, "F", "yellow", 10);
		pigeon.flight();
		pigeon.land();
		pigeon.takeOff();
		pigeon.nutrition();
		...
		Snake snake = new Snake(4, "Cola", "cornsnake", 5, 7, EnclosureType.REPTILE_CREEK, false, false, "F", false, "black", "circles");
		snake.floats();
		System.out.println("\n");
